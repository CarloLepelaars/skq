...
def test_amplitude_encoder():
    ...
    test_arr = np.array([0.1 + 2j, -0.6 - 2j, 1.0 + 1.3j, 0.0 - 1.5j])

    encoded_arr = encoder.fit_transform(test_arr)
    expected_output = np.array([0.02741012 + 0.54820244j, -0.16446073 - 0.54820244j, 0.27410122 + 0.35633159j, 0.0 - 0.41115183j])
